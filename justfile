...
benchmark: closest cluster complement coverage extend flank intersect merge random sample shift sort spacing subtract unionbedg window

benchmark_stranded: closest_stranded coverage_stranded extend_stranded flank_stranded intersect_stranded merge_stranded subtract_stranded window_stranded
